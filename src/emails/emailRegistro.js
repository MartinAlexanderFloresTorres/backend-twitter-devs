...
const emailRegistro = async ({ email, nombre, token }) => {
  ...
  <div style="text-align: center; margin: 20px 0 30px;"><span style="font-weight: bold; color: #0284c7; font-size: 30px; margin-left: 10px;">D-twitter</span></div>
  <p style="color: #757575; font-family: 'Open Sans', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; letter-spacing: normal;">Hola ${nombre} comprueba tu cuenta en D-twitter,</p>
  ...
  const msg = {
    ...
    subject: 'Compruebe su cuenta en D-twitter',
    text: 'D-twitter',
    html: htmlConfirmar
  }
  sgMail
